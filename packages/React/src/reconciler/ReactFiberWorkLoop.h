...
public:
     ...
     */
    void performConcurrentWorkOnRoot(
      facebook::jsi::Runtime& jsiRuntime,
      react::ReactHostRuntime& hostRuntime,
      FiberRootRef root,
      bool didTimeout
     ...
     */
    void workLoopSync(facebook::jsi::Runtime& jsiRuntime, react::ReactHostRuntime& hostRuntime);
  ...
  WorkLoopState& getState();
  const WorkLoopState& getState() const;
